...
class O3TensorProduct(nn.Module):
    ...
    def vectorise(self):
        ...
        # sqrt_k_correction = torch.zeros(
        #     self.irreps_out.dim
        # ) # 1.0 is default (i.e., no sqrt_k correction), instead of 0.0? zeros causes nan anyway 
        sqrt_k_correction = torch.ones(self.irreps_out.dim)

...
def get_args():
    ...
    parser.add_argument(
        "--config_path",default="",type=str,help=""
    )
    parser.add_argument(
        "--exp_path",default="./results",type=str,help=""
    )
    parser.add_argument(
        "--xml_path",default="./environments/xmls",type=str,help=""
    )
    parser.add_argument(
        "--seed", default=0, type=int, help="sets Gym, PyTorch and Numpy seeds"
    )
    parser.add_argument(
        "--gpu", default=-1, type=int, help="gpu"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=1,
        type=int,
        help="If set to 1, load the buffer together with the model.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default="swat",
        choices=["smp", "swat","set","mlp","mlp_v","segnn"],
